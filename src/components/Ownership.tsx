...
const founders = [
  {
    ...
    icon: <Shield className="w-10 h-10 text-light-cyan" />,
  ...
  },
  {
    ...
    icon: <Star className="w-10 h-10 text-light-cyan" />,
    desc: "Drives the elite community experience and ensures the balance of the ecosystem."
  }
];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-8">
          <div className="max-w-2xl">
            ...
            >
              ...
              <span className="font-technical text-xs text-light-cyan uppercase tracking-[0.4em] font-black">Administration Hierarchy</span>
            </motion.div>
            <motion.h2 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-1px bg-white/5 border border-white/5">
          {founders.map((founder, i) => (
            ...
            >
              {/* HUD Corner markers inside the grid cell */}
              ...
              <div className="relative mb-10 flex flex-col items-center justify-center">
                 ...
                 <div className="text-center">
                    <div className="font-technical text-[10px] text-light-cyan uppercase tracking-[0.3em] font-black mb-1">Elite Founder</div>
                    <h3 className="heading-massive text-4xl text-white italic group-hover:text-glow transition-all">{founder.name}</h3>
                 </div>
              </div>

              <div className="space-y-6 text-center">
                <div className="inline-block px-4 py-1 border border-white/10 text-soft-gray font-technical text-[10px] uppercase tracking-widest bg-white/5 group-hover:border-light-cyan/30 group-hover:text-white transition-colors">
                  {founder.role}
                </div>
                <p className="font-sans text-sm text-soft-gray leading-relaxed max-w-[280px] mx-auto">
                  {founder.desc}
                </p>
              </div>

              {/* Decorative side bar */}
              <div className="absolute left-0 top-1/4 bottom-1/4 w-[2px] bg-light-cyan/0 group-hover:bg-light-cyan/50 transition-all" />
            </motion.div>
          ))}
        </div>
        ...
        >
          <div className="hud-line w-24 opacity-30" />
          <p className="font-technical text-[10px] text-soft-gray uppercase tracking-[0.5em] text-center">
            Pioneering the Next Generation of Greek Roleplay
          </p>
        </motion.div>
      </div>
    </section>
