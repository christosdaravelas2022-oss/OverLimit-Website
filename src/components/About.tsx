      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4 mt-12">
            ...
            <button className="flex items-center gap-2 glass-panel border border-white/10 px-8 py-4 rounded-sm font-display text-xs font-black tracking-widest hover:border-light-cyan transition-all skew-btn" id="read-rules">
